...
class TestCustomWidgetService(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.transaction = Transaction(
            {"service": "dashboard", "api_class": "CustomWidget"}
        )
        super().setUpClass()
    ...
    def test_list_custom_widgets(self):
        custom_widget_vos = CustomWidgetFactory.build_batch(
        ...
        self.assertEqual(
            list_custom_widget_vos[0].custom_widget_id, params.get("custom_widget_id")
        )
