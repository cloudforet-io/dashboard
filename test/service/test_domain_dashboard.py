...
class TestDomainDashboardService(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.transaction = Transaction(
            {"service": "dashboard", "api_class": "DomainDashboard"}
        )
        super().setUpClass()
    ...
    def test_update_domain_dashboard_permission_error(self):
        domain_dashboard_vo = DomainDashboardFactory(
    ...
    def test_delete_domain_dashboard(self):
        domain_dashboard_vo = DomainDashboardFactory(domain_id=self.domain_id)
        domain_dashboard_version_vos = DomainDashboardVersionFactory.build_batch(
            5,
            domain_dashboard_id=domain_dashboard_vo.domain_dashboard_id,
            domain_id=self.domain_id,
        )
        ...
        for idx, domain_dashboard_version in enumerate(domain_dashboard_version_vos, 1):
            print_data(
                domain_dashboard_version.to_dict(), f"{idx}th domain_dashboard_version"
            )
    ...
    def test_revert_version(self):
        ...
        self.assertEqual(
            domain_dashboard_vo.variables_schema, first_version.variables_schema
        )
    ...
    def test_get_version(self):
        ...
        print_data(
            domain_dashboard_version_vo.to_dict(),
            "test_domain_dashboard_version_by_get_version",
        )
        ...
        self.assertEqual(
            domain_dashboard_version_vo.domain_dashboard_id,
            domain_dashboard_vo.domain_dashboard_id,
        )
        self.assertEqual(
            domain_dashboard_version_vo.layouts, domain_dashboard_vo.layouts
        )
        self.assertEqual(
            domain_dashboard_version_vo.variables, domain_dashboard_vo.variables
        )
        self.assertEqual(
    ...
    def test_list_versions(self):
        ...
        self.assertIsInstance(
            list_domain_dashboard_version_vos[0], DomainDashboardVersion
        )
    ...
    def test_get_domain_dashboard(self):
        ...
        self.assertEqual(
            domain_dashboard_vo.domain_dashboard_id,
            get_domain_dashboard_vo.domain_dashboard_id,
        )

    def test_list_domain_dashboards(self):
        domain_dashboard_vos = DomainDashboardFactory.build_batch(
        ...
        self.assertEqual(
            list_domain_dashboard_vos[0].domain_dashboard_id,
            params.get("domain_dashboard_id"),
        )
